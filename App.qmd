  ...
  output$app_credits <- renderUI({
    if (lang() == "it") {
      tagList(
        ...
        tags$a(href="https://www.mauromaver.eu", target="_blank", style="color: #2D6A4F; font-weight: 700; text-decoration: underline;", "Mauro Maver"), 
        " || Se riscontri problemi o bug, visita il mio profilo ",
        tags$a(href="https://github.com/Stramon1um", target="_blank", style="color: #2D6A4F; font-weight: 600; text-decoration: underline;", "GitHub"),
        " oppure inviami una ",
